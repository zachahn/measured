---
name: brainstorming
description: "Only use this skill if explicitly asked. Enhances Plan mode by exploring user intent, requirements and design before implementation."
---

First, switch to Plan mode.

# Enhancements to Plan mode

In addition to all of its steps, create a task for each of these items prior to

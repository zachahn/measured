...
4. Spawn a teammate using the subagent: `measured:implementation-ticketing-tech-lead`. Tell it the architecture plan is done; it reads the plan and breaks it into tickets that reference it.
